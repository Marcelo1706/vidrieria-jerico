...
--
-- Servidor: localhost
-- Tiempo de generación: 03-03-2022 a las 03:58:51
...
CREATE TABLE `saving` (
  `id` int(11) NOT NULL,
  `concept` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(3, 'Cajero', '2', 'caja2', 'caja2@jerico.com', 'cc17563a8047544ef045d70d1a28af8159ca1e8a', NULL, 1, 3, 1, '2022-02-27 05:02:18');
