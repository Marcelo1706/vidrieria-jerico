        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form class="form-horizontal" method="post" id="addproduct" action="index.php?action=import"
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <p>1. seleccione el tipo de datos que desea importar al sistema (Productos, Clientes, Proveedores,
                Usuarios)</p>
              <p>2. seleccione el archivo (.csv) que contenga los datos en base al formato de cada tipo.</p>
              <h4>Productos</h4>
              <p>Orden de los datos [Codigo, Nombre del producto, Precio de entrada, Precio de salida, Minima en
                inventario]</p>
              <pre>
...
PEP1,Pepsi,7,10,10
              ...
              <pre>
RAEA050892,Agustin,Ramos Escalante,Tabasco , evilnapsis@gmail.com, +503 7012 3456
